...
(function(){
    // fonction IFEE
    //do not forget to do console log //
    ...
    let bouton__previous= document.querySelector('.button__previous') 
    ...
    button__next.addEventListener('click', function(e){
       index++;
    ...
    bouton__previous.addEventListener('click', function(e){
        index--;
        if (index<0) {
